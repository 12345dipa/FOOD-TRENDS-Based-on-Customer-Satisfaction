...
Rule-Based Classification: Created a SentimentCategory column in Power Query based on numerical ratings (e.g., Rating >= 4 is "Positive").
AI/NLP Classification: Integrated a Python script with the VADER library to perform sentiment analysis on generated feedback text, creating SentimentScore_AI and SentimentCategory_AI columns.
